...
//!
//! 1. Send ours state-of-knowledge vector `T` (i.e. last-seen time stamp for each replica ID)
...
//! 5. | `Γ`-join, update `T` (in-memory and database; atomicity not required, duplication of knowledge does not matter)
...
//!
//! (Property: every known mod is sent to every peer, and mods for the same replica are sent in causal order)
//!
//! `Δ`-joinable and restorable (OT) sync protocol:
//!
//! 1. (TODO)
